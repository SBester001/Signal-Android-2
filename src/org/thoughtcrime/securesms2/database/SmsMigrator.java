...
public class SmsMigrator {
  ...
  {
//    if (context.getSharedPreferences("securesm2", Context.MODE_PRIVATE).getBoolean("migrated", false))
//      return;
    ...
    context.getSharedPreferences("securesm2", Context.MODE_PRIVATE).edit()
