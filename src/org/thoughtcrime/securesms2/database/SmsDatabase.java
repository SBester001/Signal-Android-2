...
import org.thoughtcrime.securesm2.database.model.SmsMessageRecord;
...
import org.thoughtcrime.securesm2.sms.IncomingGroupMessage;
...
public class SmsDatabase extends MessagingDatabase {
  ...
  public void markAsPendingInsecuresm2Fallback(long id) {
  ...
  protected Optional<InsertResult> insertMessageInbox(IncomingTextMessage message, long type) {
    ...
    boolean    unread     = (org.thoughtcrime.securesm2.util.Util.isDefaultSmsProvider(context) ||
