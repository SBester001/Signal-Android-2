...
import org.thoughtcrime.securesm2.transport.InsecureFallbackApprovalException;
import org.thoughtcrime.securesm2.transport.RetryLaterException;
...
public class PushTextSendJob extends PushSendJob implements InjectableType {
  ...
  public void onPushSend() throws NoSuchMessageException, RetryLaterException {
    ...
    try {
      ...
      warn(TAG, "Failure", e);
      database.markAsPendingInsecuresm2Fallback(record.getId());
