...
import org.thoughtcrime.securesm2.profiles.ProfileMediaConstraints;
import org.thoughtcrime.securesm2.profiles.SystemProfileUtil;
...
import org.thoughtcrime.securesm2.util.FileProviderUtil;
import org.thoughtcrime.securesm2.util.IntentUtils;
...
public class CreateProfileActivity extends BaseActionBarActivity implements InjectableType {
  ...
  private Intent createAvatarSelectionIntent(@Nullable File captureFile, boolean includeClear, boolean includeCamera) {
    ...
    if (includeClear) {
      extraIntents.add(new Intent("org.thoughtcrime.securesm2.action.CLEAR_PROFILE_PHOTO"));
    }
