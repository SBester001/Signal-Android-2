...
import org.thoughtcrime.securesm2.components.DeliveryStatusView;
import org.thoughtcrime.securesm2.components.FromTextView;
import org.thoughtcrime.securesm2.components.ThumbnailView;
import org.thoughtcrime.securesm2.components.TypingIndicatorView;
...
import org.thoughtcrime.securesm2.search.model.MessageResult;
                                             ...
                                             BindableConversationListItem, Unbindable
{
  ...
  private void setStatusIcons(ThreadRecord thread) {
    if (!thread.isOutgoing() || thread.isOutgoingCall() || thread.isVerificationStatusChange()) {
      ...
      deliveryStatusIndicator.setNone();
      alertView.setFailed();
    } else if (thread.isPendingInsecuresm2Fallback()) {
      deliveryStatusIndicator.setNone();
