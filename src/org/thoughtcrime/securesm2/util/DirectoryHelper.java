...
import org.thoughtcrime.securesm2.push.IasTrustStore;
import org.thoughtcrime.securesm2.recipients.Recipient;
import org.thoughtcrime.securesm2.sms.IncomingJoinedMessage;
import org.thoughtcrime.securesm2.util.concurrent.SignalExecutors;
...
public class DirectoryHelper {
  ...
  private static Optional<AccountHolder> getOrCreateAccount(Context context) {
    ...
    Account[]      accounts       = accountManager.getAccountsByType("org.thoughtcrime.securesm2");
  ...
  private static Optional<AccountHolder> createAccount(Context context) {
    AccountManager accountManager = AccountManager.get(context);
    Account        account        = new Account(context.getString(R.string.app_name), "org.thoughtcrime.securesm2");
