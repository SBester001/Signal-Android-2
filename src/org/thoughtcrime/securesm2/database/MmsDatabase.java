 ...
 */
package org.thoughtcrime.securesm2.database;
...
import org.thoughtcrime.securesm2.attachments.MmsNotificationAttachment;
...
import org.thoughtcrime.securesm2.database.documents.IdentityKeyMismatchList;
import org.thoughtcrime.securesm2.database.documents.NetworkFailure;
import org.thoughtcrime.securesm2.database.documents.NetworkFailureList;
import org.thoughtcrime.securesm2.database.helpers.SQLCipherOpenHelper;
...
import org.thoughtcrime.securesm2.database.model.NotificationMmsMessageRecord;
import org.thoughtcrime.securesm2.database.model.Quote;
import org.thoughtcrime.securesm2.jobmanager.JobManager;
import org.thoughtcrime.securesm2.jobs.TrimThreadJob;
import org.thoughtcrime.securesm2.logging.Log;
import org.thoughtcrime.securesm2.mms.IncomingMediaMessage;
...
import org.thoughtcrime.securesm2.util.JsonUtils;
...
import static org.thoughtcrime.securesm2.contactshare.Contact.Avatar;
import static org.thoughtcrime.securesm2.contactshare.Contact.deserialize;
...
public class MmsDatabase extends MessagingDatabase {
  ...
  public void markAsPendingInsecuresm2Fallback(long messageId) {
    long threadId = getThreadIdForMessage(messageId);
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (org.thoughtcrime.securesm2.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public class Reader implements Closeable {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = org.thoughtcrime.securesm2.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = org.thoughtcrime.securesm2.util.Util.toIsoBytes(transactionId);
