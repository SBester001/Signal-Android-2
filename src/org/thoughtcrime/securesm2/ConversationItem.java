...
import org.thoughtcrime.securesm2.attachments.DatabaseAttachment;
import org.thoughtcrime.securesm2.components.AlertView;
import org.thoughtcrime.securesm2.components.AudioView;
import org.thoughtcrime.securesm2.components.AvatarImageView;
import org.thoughtcrime.securesm2.components.ConversationItemFooter;
import org.thoughtcrime.securesm2.components.ConversationItemThumbnail;
import org.thoughtcrime.securesm2.components.DocumentView;
import org.thoughtcrime.securesm2.components.QuoteView;
import org.thoughtcrime.securesm2.components.SharedContactView;
...
import org.thoughtcrime.securesm2.database.MmsSmsDatabase;
import org.thoughtcrime.securesm2.database.SmsDatabase;
import org.thoughtcrime.securesm2.database.documents.IdentityKeyMismatch;
import org.thoughtcrime.securesm2.database.model.MediaMmsMessageRecord;
...
import org.thoughtcrime.securesm2.database.model.Quote;
import org.thoughtcrime.securesm2.jobs.AttachmentDownloadJob;
import org.thoughtcrime.securesm2.jobs.MmsDownloadJob;
import org.thoughtcrime.securesm2.jobs.MmsSendJob;
import org.thoughtcrime.securesm2.jobs.SmsSendJob;
...
import org.thoughtcrime.securesm2.mms.SlideClickListener;
import org.thoughtcrime.securesm2.mms.SlidesClickedListener;
...
import org.thoughtcrime.securesm2.util.DateUtils;
import org.thoughtcrime.securesm2.util.DynamicTheme;
import org.thoughtcrime.securesm2.util.LongClickCopySpan;
import org.thoughtcrime.securesm2.util.LongClickMovementMethod;
    ...
    implements RecipientModifiedListener, BindableConversationItem
{
  ...
  private void setStatusIcons(MessageRecord messageRecord) {
    ...
    if (messageRecord.isFailed()) {
      alertView.setFailed();
    } else if (messageRecord.isPendingInsecuresm2Fallback()) {
  ...
  private void setFooter(@NonNull MessageRecord current, @NonNull Optional<MessageRecord> next, @NonNull Locale locale, boolean isGroupThread) {
    ...
    if (current.getExpiresIn() > 0 || !current.isSecure() || current.isPending() || current.isPendingInsecuresm2Fallback() ||
  ...
  private boolean shouldInterceptClicks(MessageRecord messageRecord) {
    return batchSelected.isEmpty() &&
            ...
            messageRecord.isPendingInsecuresm2Fallback() ||
