...
import org.thoughtcrime.securesm2.mms.PartUriParser;
import org.thoughtcrime.securesm2.service.KeyCachingService;
import org.thoughtcrime.securesm2.util.MemoryFileUtil;
...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.thoughtcrime.provider.securesm2/part";
  ...
  static {
    ...
    uriMatcher.addURI("org.thoughtcrime.provider.securesm2", "part/*/#", SINGLE_ROW);
  }
